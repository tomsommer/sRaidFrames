...
L["Class filtering"] = "Фильтр классов"
L["Color"] = "Цвет"
...
L["Configure statuses"] = "Настройка статусов"
...
L["Enable this buff for all classes"] = "Включит данный бафф для всех классов"
L["Energy"] = "Энергия"
...
L["Select Buff"] = "Выберите бафф"
L["Select Classes"] = "Выберите классы"
